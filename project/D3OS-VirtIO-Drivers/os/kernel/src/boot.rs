...
use crate::{
    ...
    keyboard, logger, memory, network, process_manager, scheduler, serial_port, terminal, timer, tss, pci_bus, virtio_gpu
};
...
// neu
use crate::virtio_demo::pong_demo::pong_demo;
use crate::virtio_demo::rectangle_demo::rectangle_demo;
use crate::virtio_demo::virtio_tests::{test_virgl, test_rng, play_pcm_file};
use crate::hal::HalImpl;
use virtio::transport::pci::PciTransport;
use virtio::transport::pci::bus::{PciRoot, DeviceFunction, ConfigurationAccess, BarInfo};
...
use crate::VIRTIO_SOCKET;
use crate::VIRTIO_SOUND;

use spin::Mutex;
use crate::interrupt::virtio_handler::VirtioInterruptHandler;
...
pub extern "C" fn start(multiboot2_magic: u32, multiboot2_addr: *const BootInformationHeader) {
    ...
    init_virtio_devices(fb_start_phys_addr, fb_end_phys_addr); // Framebuffer Start und Endadresse von Multiboot-LFB

    fn init_virtio_devices(fb_start_phys_addr: u64, fb_end_phys_addr: u64) {
