...
\begin{itemize}
	...
	\item \textbf{Fence:} Ein Synchronisationsobjekt im 3D-Befehlsstrom, das es dem Treiber ermöglicht, festzustellen, wann die GPU eine bestimmte Menge an Befehlen abgearbeitet hat.
\end{itemize}
